...
async def start(client, message):
    ...
    [
        [
            InlineKeyboardButton("📍 Update Channel", url="https://t.me/skillwithchiru"),
        ],
        [
            InlineKeyboardButton("👥 Support Group", url="https://t.me/skillwithchiru"),
            InlineKeyboardButton("👩‍💻 Developer", url="https://t.me/chiru52"),
        ] 
   ]
  )
    start_message = (
